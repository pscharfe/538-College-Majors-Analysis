...
* Principal Component Analysis was applied to visualize the two successful models (k-means and Hierarchical Clustering). The PCA plot from the k-means model is below:
![image](https://github.com/pscharfe/Clustering-College-Majors-in-Python/kmeans_pca_plot.png?raw=true)
